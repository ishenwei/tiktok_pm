...
class ProductAdminForm(forms.ModelForm):
    ...
    tags_selector = forms.MultipleChoiceField(
        required=False, label="Tags", widget=forms.SelectMultiple(attrs={"class": "tag-select2"})
    )
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["tags_selector"].widget.attrs.update({"data-colors": json.dumps(color_map)})
